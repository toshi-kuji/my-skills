...
Custom skills added here should be placed inside the `skills/tk/` directory (e.g., `skills/tk/structured-pdf`) to keep them distinct from the upstream Anthropic skills.

Keep this repository synced with the upstream repository by using GitHub's "Sync fork" flow regularly. Outside of custom `skills/tk/` skills and any repo-specific notes, keep the rest of the repository aligned with the latest state of https://github.com/anthropics/skills.
